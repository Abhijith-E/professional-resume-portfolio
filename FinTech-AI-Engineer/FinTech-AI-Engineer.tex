...
\newcommand{\resumeItemListStart}{%
  \begin{itemize}[leftmargin=0.18in, itemsep=1pt, topsep=2pt, parsep=0pt]%
}
...
\hspace{12pt}
\textcolor{mainblue}{\faIcon{globe}}\hspace{3pt}
\href{https://abhijith-e-portfolio.vercel.app/}{Portfolio}
}
...
\small{
AI Engineer with a specialization in Financial AI and Quantitative Intelligence, holding a Master’s degree in Artificial Intelligence \& Machine Learning from CHRIST University. Experienced in developing AI-driven financial systems for stock forecasting, portfolio optimisation, volatility prediction, sentiment-integrated trading analytics, and algorithmic decision support using Python, PyTorch, TensorFlow, FastAPI, and transformer-based architectures. Skilled in time-series modelling, quantitative analysis, and scalable fintech application development, with strong research interests in AI for financial markets, quantitative trading, generative AI, and intelligent autonomous financial systems.
}
...
\resumeProject
  {Quantum Technologies for Business -- CHRIST (Deemed to be University) \& Quokka Quantum}{2026}

\resumeItemListStart
  \resumeItem{
    Jointly administered with Quokka Quantum in collaboration with the Australian Quantum Software Network (AQSN); covered core quantum computing principles and their real-world business applications. \href{https://github.com/Abhijith-E/AbhijithE_Quantum_Technologies_for_Business_Certificate_2026/blob/main/AbhijithE_Quantum_Technologies_for_Business_Certificate_2026.pdf}{[Credential]}
  }
\resumeItemListEnd
