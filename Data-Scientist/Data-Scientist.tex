...
\small{
Data Scientist with a Master’s degree in Artificial Intelligence \& Machine Learning from CHRIST University, specializing in statistical modelling, machine learning, deep learning, and quantitative analytics. Skilled in extracting actionable insights from complex datasets and building predictive models using Python, TensorFlow, PyTorch, and time-series techniques (LSTM, TCN, ARIMA). Experienced in end-to-end data science workflows -- data pipelines, feature engineering, model development, backtesting, and visualization -- with strong interests in applied machine learning, financial analytics, and quantum machine learning.
}
